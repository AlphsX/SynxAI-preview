        ...
        <div className="grid gap-6">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div>
                <strong>Using System Preference:</strong> {isUsingSystemPreference ? 'Yes' : 'No'}
              </div>
              <div>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 p-6 rounded-lg">
            ...
            <div className="space-y-2 text-sm text-yellow-700 dark:text-yellow-300">
              <div>1. Look at your browser tab - the favicon should match the current theme</div>
              <div>2. Click &quot;Toggle Theme&quot; - favicon should change immediately</div>
              <div>
                3. Change your system theme in OS settings - if using system preference, favicon
                should follow
              </div>
              <div>4. Refresh the page - favicon should match the theme immediately on load</div>
            </div>
          </div>
          ...
          <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              Check your browser&apos;s developer console for favicon update logs.
            </div>
          </div>
        </div>
      </div>
