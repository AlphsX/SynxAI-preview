      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <li>
              Check that the cursor changes appropriately (left arrow when expanded, right arrow
              when collapsed)
            </li>
          </ul>
        </div>
          ...
          <div className="flex-1 p-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                This is the main content area. The sidebar on the left can be toggled by clicking
                anywhere on it, except on interactive elements like buttons.
              </p>
