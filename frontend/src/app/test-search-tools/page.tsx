          ...
          <div className="space-y-2 max-h-60 overflow-y-auto">
            {logs.length > 0 ? (
              logs.map((log, index) => (
                <div
                  key={index}
                  className="p-2 bg-gray-50 dark:bg-gray-700 rounded text-sm text-gray-600 dark:text-gray-400"
                >
                  {log}
                </div>
              ))
              ...
              <p className="text-gray-500 dark:text-gray-400 italic">
                No events yet. Click on a tool to see logs here.
              </p>
            )}
          </div>
        </div>
