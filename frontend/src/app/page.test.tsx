...
jest.mock("@/components/magicui", () => ({
  AnimatedThemeToggler: () => (
    <div data-testid="theme-toggler">Theme Toggler</div>
  ),
  VoiceThemeNotification: () => (
    <div data-testid="voice-notification">Voice Notification</div>
  ),
...
jest.mock("@/components/magicui/ai-model-dropdown", () => ({
  AIModelDropdown: () => (
    <div data-testid="ai-model-dropdown">AI Model Dropdown</div>
  ),
}));
