      ...
      <div className="relative w-5 h-5">
        ...
        <div
          className={`absolute inset-0 transition-all duration-500 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] ${
            showSystemIcon ? 'opacity-100 rotate-0 scale-100' : 'opacity-0 rotate-[360deg] scale-0'
          }`}
        >
          <Monitor size={20} />
        </div>
        ...
        <div
          className={`absolute inset-0 transition-all duration-500 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] ${
            showSunIcon ? 'opacity-100 rotate-0 scale-100' : 'opacity-0 rotate-[360deg] scale-0'
        ...
        <div
          className={`absolute inset-0 transition-all duration-500 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] ${
            showMoonIcon ? 'opacity-100 rotate-0 scale-100' : 'opacity-0 rotate-[-360deg] scale-0'
