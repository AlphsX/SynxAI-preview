...
from app.external_apis.news_router import router as news_router
...
# Configure LangSmith tracing for production
def configure_langsmith():
    ...
    try:
        ...
        if hasattr(settings, 'LANGCHAIN_ENDPOINT') and settings.LANGCHAIN_ENDPOINT:
...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {
            "name": "memory",
            "description": "LangChain conversation memory management with LangSmith tracing"
        },
        {
            "name": "news",
            "description": "Intelligent news search from Reuters, BBC, NYT, Washington Post, WSJ"
        },
        {
            "name": "analytics",
